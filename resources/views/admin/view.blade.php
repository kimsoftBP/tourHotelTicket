...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light sidebar">-->
  	...
  	<div class="wrapper col-lg-12 mw-100 adminzindex p-0" style="">
  		<!-- Sidebar Holder -->
      @php
        $user=Auth::user();
      @endphp
          ...
          @endif
  			...
  			<ul class="list-unstyled components">
  				<!--	                <p>Dummy Heading</p>-->
          @if($user->permcontinentadmin() || $user->permadmin())
            <li>
              <a href="{{route('admin.dashboard',app()->getLocale())}}">Dashboard</a>
            </li>
          @endif

          <li>
            <a href="{{route('admin.product',app()->getLocale())}}">Product</a>
          </li>
          @if($user->permcontinentadmin() || $user->permadmin())
            <li>
              <a href="{{route('admin.cities',app()->getLocale())}}">Cities</a>
            </li>
            <li>
              <a href="{{route('admin.users',app()->getLocale())}}">Users</a>
            </li>
          @endif
          @if($user->permadmin())
            <li>
              <a href="{{route('admin.advertising',app()->getLocale())}}">{{__('messages.advertising')}}</a>
            </li>
          @endif
          <!--
  				<li class="">
  		...
  		<!-- Page Content Holder -->
  		<div id="content2" class="col-md-12 col-lg-10 mw-100 adminzindex" style="min-width: 70%;">
  			...
  			<div id="content" class="pl-0 pr-0 adminzindex" style="">
          @php
