...
class RestaurantSubpageController extends Controller
{
    //
    public function subpage(Request $req, $locale,$region, $country,$pageid){
        ...
        $data['subpage']=Subpage::where('id',$pageid)
            ->whereHas('RestaurantCompany',function($query)use($countryObj){
        ...
        return view('restaurant.subpage')->with('data',$data);
    }
}
