...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        //\App\Http\Middleware\LogGeolocation::class, //bug duplication 
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\LogGeolocation::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'verified'=>\App\Http\Middleware\CustomEnsureEmailsVerified::class,
